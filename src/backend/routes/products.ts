...
productsRouter.get('/:listNumber', async (req: Request<{ listNumber: string }>, res: Response) => {
    try {
...
productsRouter.post('/', async (req: Request<{}, {}, Products>, res: Response) => {
...
productsRouter.put('/:id', putHandler);
